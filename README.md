...
**Bilişim Sistemleri Uzmanı | Erasmus+ Koordinatörü | Proje Yöneticisi**

Teknoloji ve uluslararası iş birliklerini bir araya getirerek Avrupa temalı inovasyon projeleri geliştiriyorum. Yazılım geliştirme yetkinliklerimi (Python, Flutter) uluslararası hibe projeleri (Erasmus+ KA152, KA154, TÜBİTAK) ile harmanlayarak sınır ötesi dijital kalkınma odaklı çözümler üretiyorum ve sahada gerçek etkiler yaratıyorum.

## 🚀 Neler Yapıyorum

- 🇪🇺 **Avrupa Temalı Projeler:** Erasmus+ ve TÜBİTAK projelerinde Koordinatör olarak uluslararası operasyonları yönetiyorum.
- 💻 **Yazılım Geliştirme:** Python ve Flutter üzerinde çalışıyor, projelerin dijital altyapılarını tasarlıyorum.
- 🌾 **Tarım 4.0 & Kırsal İnovasyon:** Akıllı tarım ve kırsal kalkınma odaklı teknolojiler de geliştiriyorum (Agro-Lab Kurucusu).
- 👨‍🏫 Eski bir GDSC Lideri ve Yapay Zeka Atölye Eğitmeniyim.
...
- **LinkedIn:** [linkedin.com/in/elkatmisfurkan](https://linkedin.com/in/elkatmisfurkan)
- **E-posta:** [elkatmisfurkan@example.com](mailto:elkatmisfurkan@example.com)

*Eğlenceli Gerçek: Teknolojinin ve Avrupa projelerinin yanı sıra sahayı tam anlamıyla kavramak için Gıda Teknolojisi eğitimi de alıyorum!*
